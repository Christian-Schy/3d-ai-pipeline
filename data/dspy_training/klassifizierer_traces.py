...
TRACES.extend([
    ...
    {
        "id": "klass_curated_bohrung_b2v2_abstand_keyword_oben_rechts",
        "phrase": "oben 10mm bohrung mit abstand 20 von oben und 30 von rechts 5 tief",
        "teil_type": "box",
        "teil_params": {"x": 200, "y": 200, "z": 200},
        "parent_phrase": "(keine)",
        "expected": {
            ...
            "parameter_hints": {"durchmesser": 10, "tiefe": 5,
                                "abstand_oben": 20, "abstand_rechts": 30},
        },
        "source_run": None,
        "bug_pattern": "B2 v2 Golden: 'mit abstand N von oben/rechts' -> abstand_* auf zwei Achsen",
    },
    {
        "id": "klass_curated_bohrung_b2v3_telegraphisch_oben_rechts",
        "phrase": "oben oben 20mm rechts 30mm entfernt eine 10mm bohrung 5 tief",
        "teil_type": "box",
        "teil_params": {"x": 200, "y": 200, "z": 200},
        "parent_phrase": "(keine)",
        "expected": {
        ...
        "source_run": None,
        "bug_pattern": "B2 v3 Golden: telegrammartiges 'oben N rechts M entfernt' -> beide abstand_*-Achsen",
    },
    {
    ...
    {
        "id": "klass_curated_nested_bohrung_in_der_tasche_side_inherit",
        "phrase": "in der tasche eine 8mm bohrung 5 tief zentral",
        "teil_type": "box",
        "teil_params": {"x": 200, "y": 120, "z": 40},
        "parent_phrase": "oben eine tasche 60x40x10",
        "expected": {
        ...
        "source_run": None,
        "bug_pattern": "NEST Routing-Fix: lokatives 'in der Tasche' ist Parent-Kontext, keine zweite Feature-Familie",
    },
    {
...
TRACES.extend([
    ...
    {
        "id": "klass_v2_pattern_lochkreis_offset_um_versetzt",
        "phrase": "oben ein lochkreis 50mm mit 6 bohrungen 5mm durchmesser 4 tief um 10mm nach links und 5mm nach unten versetzt",
        "teil_type": "box",
        "teil_params": {"x": 120, "y": 90, "z": 50},
        "parent_phrase": "(keine)",
        "expected": {
        ...
        "source_run": None,
        "bug_pattern": "V2 lochkreis: 'um/nach ... versetzt' beschreibt den Pattern-Mittelpunkt, nicht Kantenabstaende",
    },
