...
# Token-Budget: System ~250 + Input ~200 = ~450 total — winzig, schnell.
#
...
★ Saetze die nichts mit Platzierung oder Features zu tun haben (z.B. Masse-
  Wiederholungen) weglassen.

PLATZIERUNG erkennt man an:
  - Seitenangaben (oben, unten, rechts, links, vorne, hinten, drauf, an, auf)
  - Ausrichtung (buendig, zentriert, in der ecke, an der kante)
  - Anliegende Flaeche ("die 100x20 seite liegt auf")
  - Kanten/Ecken-Bezuege ("obere kante 10mm von ...", "linke obere ecke auf ...")
  - Drehung des Teils selbst ("um 10 grad gedreht", "hochkant", "flach")

FEATURE erkennt man an:
